...
class PizzasControllerTest < ActionController::TestCase
  ...
  test "should create pizza" do
    assert_difference('Pizza.count') do
      post :create, pizza: { cost: @pizza.cost, crust: @pizza.crust, image: @pizza.image, name: @pizza.name, sauce: @pizza.sauce, size: @pizza.size, toppings: @pizza.toppings }
    end
  ...
  test "should update pizza" do
    patch :update, id: @pizza, pizza: { cost: @pizza.cost, crust: @pizza.crust, image: @pizza.image, name: @pizza.name, sauce: @pizza.sauce, size: @pizza.size, toppings: @pizza.toppings }
    assert_redirected_to pizza_path(assigns(:pizza))
  end
